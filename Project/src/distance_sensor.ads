...
package Distance_sensor is
   ...
   protected Sensor_flag is                                                   --Declares protected object which                                                                      --encapsulates the flag value used to
   ...
   task Sensor_loop with Priority => 3;                                       --Declares a task to be used to loop                                                                             --the sensor functions so as t                                                                             --test continuously whether                                                                           --is too near another object.
end Distance_sensor;
