...
package body AccelerometerTask_pk is
   ...
   task body AccelerometerTask is                                               -- The variable Data collect data from the accelerometer and the type All_Axes_Data 
      Data: All_Axes_Data; 
   ...
   begin 
      ...
      loop
         ...
         Acc_Storage_pk.storage.upright(not(Overturned));                       -- This line set the the protectet object in the Acc_Storage_pk. 
